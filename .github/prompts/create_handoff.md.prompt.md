...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/EMS-XXXX/YYYY-MM-DD_HH-MM-SS_EMS-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - EMS-XXXX is the ticket number (replace with `general` if no ticket)
        - EMS-ZZZZ is the ticket number (omit if no ticket)
...
# Handoff: EMS-XXXX {very concise description}
...
```bash
/resume_handoff thoughts/shared/handoffs/EMS-2166/2025-01-08_13-44-55_EMS-2166_create-context-compaction.md
```
</example_response>
